...
class Crypto {
  ...
  /**
   * Cryptographically signs a message with the give private key.
   *
   * @param {string} message The message to sign
   * @param {string} privateKye The base64url encoded private key to sign with.
  ...
  /**
   * Verifies a cryptographically signed message give a a signature and public key.
   *
  ...
  /**
   * Encrypts a file from the given handle with the give access key.
   *
  ...
  /**
   * Decrypts a file from the give source with the give access key.
   *
